...
или обученной моделью. Markdown-спецификация корпуса, предварительная `T_v1` и
начальный правовой аудит уже созданы, но машинные реестры с основаниями и
режимами получения, версионируемая предварительная обработка, дедупликация,
разбиения, конфигурации, тесты, обучение и единый конвейер оценки пока не
реализованы.
