...
data/splits/     # версионированные списки work_id для обучающей, проверочной и тестовой выборок
```
